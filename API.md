...
#### 请求URL:  
```
https://localhost:3000/v1/cities
```

#### 示例：
 [https://localhost:3000/v1/cities?type=guess](https://elm.cangdu.org/v1/cities?type=guess)
...
#### 请求URL：
```
https://localhost:3000/v1/cities/:id
```

#### 示例：
[https://localhost:3000/v1/cities/1](https://elm.cangdu.org/v1/cities/1)
...
#### 请求URL：
```
https://localhost:3000/v1/pois
```

#### 示例：
[https://localhost:3000/v1/pois?city_id=1&keyword=迪士尼&type=search](https://localhost:3000/v1/pois?city_id=1&keyword=%E8%BF%AA%E5%A3%AB%E5%B0%BC&type=search)
...
#### 请求URL：
```
https://localhost:3000/v1/users/:user_id/getaddress
```

#### 示例：

[https://localhost:3000/v1/users/:user_id/getaddress](https://localhost:3000/v1/users/:user_id/getaddress)
...
#### 请求URL：
```
https://localhost:3000/v1/users/:user_id/increaseaddress
```
